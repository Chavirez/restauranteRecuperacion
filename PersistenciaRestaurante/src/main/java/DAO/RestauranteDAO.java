...
public class RestauranteDAO implements IRestauranteDAO {
    ...
    public void actualizarRestaurante(Restaurante restaurante) throws PersistenciaException {
        ...
        try {
            ...
            Restaurante rActualizar = entityManager.find(Restaurante.class, restaurante.getId());
            if (rActualizar != null) {
                // Ahora la entidad es "managed" y puede ser actualizada
                rActualizar.setHoraApertura(restaurante.getHoraApertura());
                rActualizar.setHoraCierre(restaurante.getHoraCierre());
                entityManager.merge(rActualizar);
            }
