...
public class ReservaNegocio implements IReservaNegocio {
    ...
    public List<ReservaDTO> buscarReservasPorMesa(MesaDTO mesa) throws NegocioException {
        ...
        System.out.println(reservasEncontradas.toString());
    ...
    public void llenarReservasMasivamente() throws NegocioException{
        ...
        try {
            ...
            fechaReserva1.set(2024, 12, 11, 11, 30);
            ...
            fechaReserva2.set(2024, 12, 11, 16, 30);
            ...
            fechaReserva3.set(2024, 12, 11, 21, 30);
            ...
            fechaReserva4.set(2024, 12, 11, 9, 15);
            ...
            fechaReserva5.set(2024, 12, 11, 15, 45);
            ...
            fechaReserva6.set(2024, 12, 11, 21, 59);
            ...
            fechaReserva8.set(2024, 12, 13, 14, 15);
            ReservaDTO reserva8 = new ReservaDTO(fechaReserva8, 2, 300, mesas.get(23), clientes.get(6), "Ventana");
            
            Calendar fechaReserva9 = Calendar.getInstance();
            fechaReserva9.set(2024, 12, 2, 15, 45);
            ...
            fechaReserva10.set(2024, 12, 15, 9, 59);
            ...
            fechaReserva11.set(2024, 12, 11, 11, 30);
            ...
            fechaReserva12.set(2024, 12, 11, 16, 30);
            ...
            fechaReserva13.set(2024, 12, 11, 21, 30);
            ...
            fechaReserva14.set(2024, 12, 11, 9, 15);
            ...
            fechaReserva15.set(2024, 12, 11, 15, 45);
            ...
            fechaReserva16.set(2024, 12, 11, 21, 59);
            ...
            fechaReserva18.set(2024, 12, 13, 14, 15);
            ReservaDTO reserva18 = new ReservaDTO(fechaReserva18, 4, 500, mesas.get(39), clientes.get(5), "Ventana");
            
            Calendar fechaReserva19 = Calendar.getInstance();
            fechaReserva19.set(2024, 12, 12, 15, 45);
            ...
            fechaReserva20.set(2024, 12, 15, 9, 59);
            ...
            fechaReserva21.set(2024, 12, 5, 11, 30);
            ...
            fechaReserva22.set(2024, 12, 4, 16, 30);
            ...
            fechaReserva23.set(2024, 12, 2, 21, 30);
            ...
            fechaReserva24.set(2024, 12, 5, 9, 15);
            ...
            fechaReserva25.set(2024, 12, 8, 15, 45);
            ...
            fechaReserva26.set(2024, 12, 4, 21, 59);
            ...
            fechaReserva28.set(2024, 12, 7, 14, 15);
            ...
            fechaReserva29.set(2024, 12, 13, 15, 45);
            ...
            fechaReserva30.set(2024, 12, 11, 9, 59);
            ReservaDTO reserva30 = new ReservaDTO(fechaReserva30, 8, 800, mesas.get(16), clientes.get(17), "Patio");
